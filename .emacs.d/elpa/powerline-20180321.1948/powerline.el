...
(setq evil-normal-state-tag   (propertize "[N]" 'face '((:background "grey23"   :foreground "#959595")))
      evil-emacs-state-tag    (propertize "[E]" 'face '((:background "grey23"   :foreground "#959595")))        evil-insert-state-tag   (propertize "[I]" 'face '((:background "#8faeae"  :foreground "#262626")))
      evil-replace-state-tag  (propertize "[R]" 'face '((:background "#grey23"  :foreground "#959595")))
      evil-motion-state-tag   (propertize "[M]" 'face '((:background "#grey23"  :foreground "#959595")))
      evil-visual-state-tag   (propertize "[V]" 'face '((:background "orange"   :foreground "#262626")))
      evil-operator-state-tag (propertize "[O]" 'face '((:background "#grey23"  :foreground "#959595"))))
...
(defface powerline-active0 '((t (:foreground "#262626" :weight bold :background "#959595" :inherit mode-line)))
  "Powerline face 0."
  :group 'powerline)

(defface powerline-active1 '((t (:background "#4e4e4e" :foreground "#959595" :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:background "grey23" :foreground "#959595" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-hud-active
  '((t (:background "orange" :inherit mode-line)))
  "Powerline hud face."
  :group 'powerline)


(defface powerline-inactive0
  '((t (:background "grey20" :weight bold :inherit mode-line-inactive)))
  "Powerline face 0."
  :group 'powerline)

(defface powerline-inactive1
  '((t (:background "grey15" :inherit mode-line-inactive)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-inactive2
  '((t (:background "grey10" :inherit mode-line-inactive)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-hud-inactive
  '((t (:background "grey10" :inherit mode-line-inactive)))
  "Powerline hud face."
  :group 'powerline)
