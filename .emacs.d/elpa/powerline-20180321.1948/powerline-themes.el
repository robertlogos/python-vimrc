...
(defun powerline-robertlogos-theme ()
    ...
    '("%e"
      (:eval
       (let* (
         ...
         (facehud (if active 'powerline-hud-active 'powerline-hud-inactive))
         ...
         (center (list (powerline-raw evil-mode-line-tag face2)
         ...
         (rhs (list (powerline-raw global-mode-string face2 'r)
                    ...
                    (powerline-raw "%3l" face1)
                    (powerline-raw ":" face1)
                    (powerline-raw "%2c " face1)
                    (funcall separator-right face1 face0)                        
                    (powerline-raw " %6p  " face0)
                    (powerline-hud face2 facehud 3))))
